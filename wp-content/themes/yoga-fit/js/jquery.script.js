...
jQuery(function ($) {
	...
	function resize_price_table_columns() {
		if ($(window).width() >= 1025) {
			$('.cmsms_pricing_item .feature_list').setAllToMaxHeight();
		}
		else {
			$('.cmsms_pricing_item .feature_list').css('height', 'auto');
		}
	}
	
	$('.cmsms_pricing_item .feature_list').css('height', 'auto');
	resize_price_table_columns();
