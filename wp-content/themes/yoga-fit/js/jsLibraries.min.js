 ...
 */
(function(e){"use strict";var t=e.event,n,r;n=t.special.debouncedscroll={setup:function(){e(this).on("scroll",n.handler)},teardown:function(){e(this).off("scroll",n.handler)},handler:function(e,i){var s=this,o=arguments,u=function(){e.type="debouncedscroll";t.dispatch.apply(s,o)};if(r){clearTimeout(r)}i?u():r=setTimeout(u,n.threshold)},threshold:150}})(jQuery);
